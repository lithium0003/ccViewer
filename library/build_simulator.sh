...
export CFLAGS="-miphonesimulator-version-min=17.0"
export CXXFLAGS="-miphonesimulator-version-min=17.0"
export LDFLAGS="-miphonesimulator-version-min=17.0"
